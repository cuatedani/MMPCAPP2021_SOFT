...
public class InterfaceRegistrarUsuario extends javax.swing.JFrame {

    ConectarBD BD;
    DefaultTableModel modelo;

    public InterfaceRegistrarUsuario(ConectarBD con) {
        initComponents();
        BD = con;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        BD.RegistrarUsuario(nom, clav, perm, cre, true);
        MostrarUsuario();
        jTable1.setModel(modelo);
