...
public class InterfacePrincipalEmpleado extends javax.swing.JFrame {

    ConectarBD BD;

    public InterfacePrincipalEmpleado(ConectarBD con) {
        initComponents();
        BD = con;
    ...
    private void initComponents() {
        ...
        jButton2.setText("GESTIONAR EVENTOS");
        ...
        jButton3.setText("GESTIONAR PROVEEDORES");

        jButton4.setText("GESTIONAR SERVICIOS");

        jButton5.setText("GESTIONAR REPORTES");
