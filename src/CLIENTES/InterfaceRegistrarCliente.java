...
public class InterfaceRegistrarCliente extends javax.swing.JFrame {

    ConectarBD BD;

    public InterfaceRegistrarCliente(ConectarBD con) {
        initComponents();
        BD = con;
    ...
    private void initComponents() {
        ...
        jLabel9.setFont(new java.awt.Font("Buttershine", 0, 48)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(241, 172, 133));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty()
            ...
            BD.RegistrarCliente(nom, app, apm, tel, dir, loc, mail);
